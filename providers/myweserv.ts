...
export interface MyweservOptions extends ImageOptions {
  /**
...
export const getImage: ProviderGetImage = (src, options: Partial<MyweservOptions>) => {
  ...
  if (typeof options.baseURL !== 'string' || options.baseURL.length === 0) {
    if (import.meta.dev) {
      ...
      throw createError({
        ...
        message: 'The myweserv provider requires the baseURL of your website.',
        data: {
          provider: 'myweserv',
          src,
