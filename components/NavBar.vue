            ...
            <li tabindex="1">
              <details>
                ...
                <ul class="">
                  ...
                  <li>
                    <a href="/lc/coccinelle">Cerchio del Bosco Gioioso</a>
                  </li>
            ...
            <li tabindex="2">
              <details>
                ...
                <ul class="">
                  ...
                  <li>
                    <a href="/eg/campetti">Campi di Specialità e Competenza</a>
                  </li>
                  <li>
                    <a href="/eg/specialità-brevetti">Specialità e Brevetti</a>
                  </li>
                </ul>
              </details>
            </li>
